...
NameBit = namedtuple("NameBit", ["name", "bit", "result_exceptions"])
...
for formation_id in boss_objective_ids:
    boss_bit.append(NameBit(normal_formation_name[formation_id], battle_bit.boss_defeated(formation_id), [])) # TODO: exceptions here depend upon randomization

dragon_bit = []
for formation_id in sorted(dragon_formation_name, key = dragon_formation_name.get):
    dragon_bit.append(NameBit(dragon_formation_name[formation_id], battle_bit.dragon_defeated(formation_id), [])) # TODO: exceptions here depend upon randomization
